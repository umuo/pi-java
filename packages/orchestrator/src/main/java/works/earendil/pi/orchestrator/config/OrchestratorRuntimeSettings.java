...
public record OrchestratorRuntimeSettings(RestartSettings restart, LogRotationSettings logRotation) {
    ...
    public OrchestratorRuntimeSettings {
        restart = restart == null ? DEFAULT_RESTART : restart;
        logRotation = logRotation == null ? DEFAULT_LOG_ROTATION : logRotation;
    }

    public static OrchestratorRuntimeSettings defaults() {
        return new OrchestratorRuntimeSettings(DEFAULT_RESTART, DEFAULT_LOG_ROTATION);
    }
